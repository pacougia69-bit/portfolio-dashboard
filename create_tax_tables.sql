-- Create tax management tables for Railway database
...
SELECT 'tax_settings table created successfully' as status;
SELECT 'tax_sources table created successfully' as status;
